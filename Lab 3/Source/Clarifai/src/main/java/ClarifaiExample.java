...
/**
 * Created by Achu on 02-08-2017.
 */
public class ClarifaiExample {
    public static void main(String[] args) throws IOException {


        final ClarifaiClient client = new ClarifaiBuilder("h8omgfTgL52U60aXqhDvwgEz1UuXLTNWGZDjbIgP", "WgytSd-O0bVCdfyZZSuzP9a2AB5F_D5tYKIPE2s1")
        ...
        ClarifaiResponse response = client.getDefaultModels().generalModel().predict()
                .withInputs(
                        ClarifaiInput.forImage(ClarifaiImage.of(new File("input/NFL.jpg")))
                )
                .executeSync();
        ...
        if (predictions.isEmpty()) {
            ...
            MBFImage image = ImageUtilities.readMBF(new File("input/NFL.jpg"));
