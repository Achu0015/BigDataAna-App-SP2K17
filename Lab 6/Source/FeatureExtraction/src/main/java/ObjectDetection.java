...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/video2.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/Img1.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/Img2.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/Img3.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
