...
#cifar = input_data.read_data_sets("cifar_data/", one_hot=True)
...
#new_saver = tf.train.import_meta_graph('data/cifar_model/00000001/export.meta')
#new_saver.restore(sess, 'data/cfiar_model/00000001/export')
